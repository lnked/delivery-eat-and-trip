    ...
    $.popup = {
        ...
        notification: function(title)
        {
            ...
            if (!$body.find('#alert-popup-notification').length)
            {
                ...
                const noty = $(template(defaults.template.notification, { 'title': title } ));
        ...
        message: function(title, text, btn)
        {
            ...
            const temp = $(template(defaults.template.message, {'title': title, 'text': text, 'btn': btn || null }));
        ...
        error: function(title, text)
        {
            ...
            const temp = $(template(defaults.template.error, { 'title': title, 'text': text }));
